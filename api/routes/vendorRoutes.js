...
router.get("/menu", async (req, res) => {
    try {
        ...
        // 使用token读取id
        const restaurantIdFromToken = req.user.restaurant_id;
        ...
        console.log("📡 [DEBUG] Fetching menu for restaurant_id:", restaurantIdFromToken);
...
router.post("/menu", validate(addMenuItemSchema), async (req, res) => {
    try {
        ...
        console.log("📡 [DEBUG] Inserting new food:", { restaurantIdFromToken, name, description, price, image });
...
router.delete("/menu/:id", validate(deleteMenuItemSchema), async (req, res) => {
    try {
        ...
        console.log("📡 [DEBUG] Del food:", { id, restaurantIdFromToken});
